...
```{r, echo = TRUE}
# Make and/or change working directory if needed
cdir <- getwd()
wdir <- "/home/svs/dvs/R_datascientist/Activity_data/"
zipfilename <- "activity.zip"
filename <- "activity.csv"

# Put files to correct directory
if(!file.exists(wdir)){
  dir.create(wdir)
}
...
# Dowload the archive and extract files 
